  ...
  return (
    <div className="min-h-screen bottom-6 mx-auto max-w-7xl px-4 sm:mt-24 md:mt-24 text-center">
      ...
      <p className="mt-10 max-w-md mx-auto">
        ...
        of disc golf. We are now a full-service disc golf company, with a team of professional
        players and instructors.
      </p>

      <p className="mt-10 max-w-md mx-auto">
        Please take the time to read the latest in the disc golf industry and about your favorite
        players.
      </p>
      <p className="mt-10 max-w-md mx-auto">
